...
const Navbar = () => {
  ...
  return (
    <>
      <nav className="border-b bg-white/90 dark:bg-[#0d0b14]/60 border-gray-200 dark:border-white/10 backdrop-blur-md sticky top-0 z-[100] transition-colors duration-300">
